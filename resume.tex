...
\resumeItemListStart
\resumeItem{Investigating dimension importance estimation/query performance prediction with
  deep learning embeddings generated for information retrieval}
...
\resumeSubheading
{Undergraduate Digital Engineer}{Jan. 2024 -- Jun. 2024}
{Hatch}{Brisbane, QLD}
\resumeItemListStart
...
\resumeItem{Utilising Research in Visual Simultaneous Localisation and Mapping in ROS2 with
  RGB camera for autonomous path planning in GPS denied environments}
\resumeItemListEnd
...
\begin{itemize}[leftmargin=0.15in, label={}]
  \small{\item{
                ...
                \textbf{Developer Tools}{: Git, Linux, (Neo)Vim, i3wm, VS Code, Vivado, Jupyter Notebook, Jira, Latex} \\
